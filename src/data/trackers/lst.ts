...
export const lst: TrackerRegistryEntry = {
  ...
  url: "https://lst.gg",
  description:
    "Community-built Movie/TV/Fanres database with a strong focus on HD content. Known for one of the best Fanres selections available. Hosts a 300TB+ public seedbox archive with dedicated 1Gbit connection.",
  platform: "unit3d",
  apiPath: "/api/user",
  specialty: "General",
  contentCategories: [
  ...
  userClasses: [
    ...
    {
      name: "Goldfish",
      requirements: "Seedsize path: 100 GiB seedsize, 0.60 ratio, 1 month, seeding 1 week",
    },
    {
      name: "Lobster",
      requirements: "Seedsize path: 500 GiB seedsize, 0.70 ratio, 2 months, seeding 2 weeks",
    },
    {
      name: "Sailboat",
      requirements:
        "Seedsize path: 10 TiB seedsize, 1.00 ratio, 6 months, seeding 2 months, 25 torrents",
    },
    {
      name: "Ship",
      requirements:
        "Seedsize path: 20 TiB seedsize, 1.50 ratio, 1 year, seeding 3 months, 50 torrents",
    },
    {
      name: "Cargo Ship",
      requirements:
        "Seedsize path: 50 TiB seedsize, 2.00 ratio, 2 years, seeding 6 months, 75 torrents",
    },
    {
      name: "Dolphin",
      requirements:
        "Upload path: 10 TiB uploaded, 5 uploads, 1.00 ratio, 3 months, seeding 2 weeks 6 days, 20 torrents",
    },
    {
      name: "Whale",
      requirements:
        "Upload path: 25 TiB uploaded, 10 uploads, 1.00 ratio, 4 months, seeding 1 month, 25 torrents",
    },
    {
      name: "Leviathan",
      requirements:
        "Upload path: 50 TiB uploaded, 15 uploads, 1.50 ratio, 1 year, seeding 3 months, 50 torrents",
    },
    {
      name: "Cthulhu",
      requirements:
        "Upload path: 100 TiB uploaded, 20 uploads, 2.00 ratio, 2 years, seeding 6 months, 75 torrents",
    },
  ],
  releaseGroups: [
