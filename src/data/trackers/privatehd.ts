...
export const privatehd: TrackerRegistryEntry = {
  ...
  description:
    "HD and UHD movies and TV. Part of the AvistaZ network. 60 day login requirement, must download 1 torrent every 90 days.",
  ...
  // ── Visual ──────────────────────────────────────────────────────────
  color: "#5c6bc0",
  logo: "/tracker-logos/privatehd_logo.png",
