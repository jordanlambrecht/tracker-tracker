...
export const aither: TrackerRegistryEntry = {
  ...
  userClasses: [
    ...
    { name: "Harmonia", requirements: "Upload ≥ 500 GiB or seed size ≥ 1 TiB, ratio ≥ 0.6, age ≥ 1 month. 10 download slots" },
    { name: "Zeus", requirements: "Upload ≥ 2 TiB or seed size ≥ 2 TiB, ratio ≥ 0.6, age ≥ 3 months, avg seedtime ≥ 10 days. 25 download slots" },
    { name: "Helios", requirements: "Upload ≥ 5 TiB or seed size ≥ 5 TiB, ratio ≥ 0.8, age ≥ 6 months, avg seedtime ≥ 20 days, 1+ upload. 50 download slots, invite sending" },
    { name: "Prometheus", requirements: "Upload ≥ 10 TiB or seed size ≥ 10 TiB, ratio ≥ 1.0, age ≥ 8 months, avg seedtime ≥ 45 days, 5+ uploads. Invite forum" },
    { name: "Oceanus", requirements: "Upload ≥ 20 TiB or seed size ≥ 20 TiB, ratio ≥ 1.5, age ≥ 1 year, avg seedtime ≥ 2 months, 10+ uploads. Torrent mod bypass" },
    { name: "Gigantes", requirements: "Upload ≥ 40 TiB or seed size ≥ 40 TiB, ratio ≥ 1.5, age ≥ 1y 3m, avg seedtime ≥ 3 months, 15+ uploads. Freeleech" },
    { name: "Titan", requirements: "Upload ≥ 100 TiB or seed size ≥ 65 TiB, ratio ≥ 2.0, age ≥ 2 years, avg seedtime ≥ 6 months, 20+ uploads. Freeleech, H&R immune" },
    // Staff-assigned
    { name: "Junior Uploader", requirements: "Staff — junior role model uploader. Torrent mod bypass" },
    ...
    { name: "Contributor", requirements: "Staff — contributes work to Aither. Freeleech, H&R immune" },
    { name: "Trustee", requirements: "Staff — friends of the site. Freeleech, H&R immune" },
    { name: "Internal", requirements: "Staff — internal release group members. Freeleech, H&R immune" },
    { name: "FLS", requirements: "Staff — front line support. Unlimited download slots" },
    { name: "Editor", requirements: "Staff — fixes torrent pages and handles reports. Unlimited download slots" },
    { name: "Torrent Moderator", requirements: "Staff — moderates torrent queue. Unlimited download slots" },
  ],
  releaseGroups: [
    { name: "ATELiER", description: "Main house group — high-quality 1080p encodes and remuxes" },
    { name: "Kitsune", description: "Primary — WEB-DL" },
    { name: "MainFrame", description: "Primary — 2160p encodes, secondary 1080p encodes and remuxes" },
  ...
  notableMembers: [],
  bannedGroups: [
    "4K4U", "afm72", "Alcaide_Kira", "AROMA", "Bandi", "BeechyBoy",
    "ben the men", "BiTOR", "Bluespots", "BOLS", "Chivaman", "CREATiVE24",
    "d3g", "DepraveD", "edge2020", "EMBER", "EVO", "FGT", "Flights",
    "FreetheFish", "Garshasp", "Ghost", "Grym", "HDS", "HDT", "Hi10",
    "HiQVE", "ImE", "ION10", "iVy", "Judas", "LAMA", "Langbard", "LION",
    "MeGusta", "MONOLITH", "MRCS", "NaNi", "Natty", "nikt0", "noxxus",
    "OEPlus", "OFT", "OsC", "Panda", "PANDEMONiUM", "PHOCiS", "PiRaTeS",
    "PYC", "QxR", "r00t", "Ralphy", "RARBG", "RCVR", "RetroPeeps",
    "RZeroX", "SAMPA", "SasukeducK", "Sicario", "SiCFoI", "Silence",
    "SkipTT", "SM737", "SPDVD", "STUTTERSHIT", "SWTYBLZ", "t3nzin",
    "TAoE", "TEKNO3D", "Telly", "TGx", "Tigole", "TSP", "TSPxL", "TWA",
    "UnKn0wn", "VDON", "VXT", "Vyndros", "W32", "Weasley[HONE]",
    "Will1869", "WKS", "x0r", "YAWNiX", "YIFY", "YTS", "YTS.MX",
  ],
  stats: {
    userCount: undefined,
