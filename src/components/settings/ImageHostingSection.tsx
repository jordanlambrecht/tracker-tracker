...
export function ImageHostingSection({ initialHasKeys }: ImageHostingSectionProps) {
  ...
  return (
    <section aria-labelledby="image-hosting-heading">
      <H2 id="image-hosting-heading" className="mb-4 flex items-center gap-2">
        Image Hosting
        <Tooltip content="Upload screenshots to approved image hosts." docs={DOCS.IMAGE_HOSTING}>
      ...
      <div className="nm-inset-sm rounded-nm-md px-4 py-3 mb-4 border border-warn/20 bg-warn/5">
        <span className="text-xs text-warn font-medium">Coming Soon</span>
        <p className="text-xs text-secondary mt-1">
          Image hosting is being set up independently. It will be integrated with Transit Papers and
          tracker screenshot uploads in a future update. For now, you can configure your API keys here
          so they're ready when the feature launches.
        </p>
      </div>
